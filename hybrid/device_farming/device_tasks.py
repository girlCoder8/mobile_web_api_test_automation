...
from hybrid.enums.device_status import DeviceStatus
...
from hybrid.utilities.database.mongo_utils import MongoUtility
...
app.conf.beat_schedule = {
    ...
    "update_device_availability": {
        "task": "hybrid.device_farming.device_tasks.check_device",
        "schedule": crontab(minute="*/2"),
    },
    # add new/unique devices to the list of devices and set their status as available
    "add_new_device_to_device_list": {
        "task": "hybrid.device_farming.device_tasks.add_new_devices_to_list",
